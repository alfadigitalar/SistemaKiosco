        ...
        <table className="w-full text-left border-collapse">
          <thead className="bg-slate-900/50 sticky top-0">
            <tr>
              ...
              <th className="p-4 text-slate-400 font-medium">DNI</th>
              <th className="p-4 text-slate-400 font-medium">Teléfono</th>
            ...
            {loading ? (
              ...
              filteredCustomers.map((customer) => (
                ...
                >
                  ...
                  <td className="p-4 text-slate-300">{customer.dni || "-"}</td>
            ...
            <form onSubmit={handleSaveCustomer} className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  required
                  className="w-full bg-slate-900 border border-slate-700 rounded-lg p-2 text-white focus:ring-2 focus:ring-purple-500 outline-none"
                  value={formData.name}
                  onChange={(e) =>
      ...
      {isDebtModalOpen && currentCustomer && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-slate-800 p-6 rounded-2xl w-full max-w-sm border border-slate-700 shadow-2xl">
            <h2 className="text-xl font-bold mb-4">Pago a Cuenta</h2>
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-slate-900 border border-slate-700 rounded-lg p-2 pl-8 text-white focus:ring-2 focus:ring-green-500 outline-none"
                    value={paymentAmount}
